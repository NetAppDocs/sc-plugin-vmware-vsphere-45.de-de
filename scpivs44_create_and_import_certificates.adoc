...
Siehe  https://kb.netapp.com/data-mgmt/SnapCenter/SC_KBs/How_to_create_and_or_import_an_SSL_certificate_to_SnapCenter_Plug-in_for_VMware_vSphere["KB-Artikel: Erstellen und/oder importieren Sie ein SSL-Zertifikat in SnapCenter Plug-in für VMware vSphere"].
