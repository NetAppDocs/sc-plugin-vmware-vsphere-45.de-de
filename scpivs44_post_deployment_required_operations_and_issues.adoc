...
+
Wenn Sie bereits SnapCenter Benutzer sind, müssen Sie Ihre bestehenden SnapCenter VM- und Datenspeicher-Backups sowie Metadaten migrieren. Weitere Informationen zur Migration finden sich unter link:scpivs44_migrate.html#migration-options["Migrationsoptionen"^].
